...
7.Modify the skeleton code TT Motor Rotate.cpp for having the motor runs clockwise for 5s, stops for 2s, runs counterclockwise for 5s and
then stop for 2s
...
– Rotation range 
– delay 
16.Modify the “Servo Motor Random.cpp” so the servo moves to random
angles between 0°and 180° and with different delays
